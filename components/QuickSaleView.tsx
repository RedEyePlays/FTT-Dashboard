...
export const QuickSaleView: React.FC<Props> = ({ inventory, customers, initialCustomer, onConsumeInitial, onSellCart, canViewProfit = true }) => {
  const isMobile = useIsMobile();
  const common = { inventory, customers, initialCustomer, onConsumeInitial, canViewProfit } as const;
  return isMobile
